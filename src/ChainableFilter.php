 ...
 */
class ChainableFilter extends AbstractFilter implements FilterInterface, FilterableInterface
{
    /**
     ...
     *
     * @param FilterableInterface $filter The filter to search for.
     * @return bool Returns true if the filter is found in the chain; otherwise, false.
     */
    public function hasFilter(FilterableInterface $filter): bool
    {
